...
1. `20260704193129_org_workspace_model.sql` — legacy org model (superseded by `001_multi_tenant.sql`)
2. `20260704193613_paying_venues_metric.sql` — paying venues view
3. `001_multi_tenant.sql` — businesses, RLS, invitations, roles, locations
